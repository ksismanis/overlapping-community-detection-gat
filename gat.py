...
class GAT(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dims, output_dim, dropout=0.5, batch_norm=False):
        ...
        self.layers = nn.ModuleList([GATConv(input_dim, layer_dims[0],heads = 2,add_self_loops=False,dropout=0,concat = False)])
        self.layers.append(GATConv(hidden_dims[0] ,output_dim, heads = 2,add_self_loops=False,dropout=0.5,concat = False ))#heads was 6
